...
#ifndef COURSE_WORK_DATA_BASE_ALLOCATOR_TEST_UTILS_H
#define COURSE_WORK_DATA_BASE_ALLOCATOR_TEST_UTILS_H
...
#endif //COURSE_WORK_DATA_BASE_ALLOCATOR_TEST_UTILS_H
