...
#ifndef COURSE_WORK_DATA_BASE_REQUEST_HANDLER_WITH_COMMAND_H
#define COURSE_WORK_DATA_BASE_REQUEST_HANDLER_WITH_COMMAND_H
#include "handler.h"
...
#endif //COURSE_WORK_DATA_BASE_REQUEST_HANDLER_WITH_COMMAND_H
