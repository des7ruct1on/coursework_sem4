...
#ifndef COURSE_WORK_DATA_BASE_CLIENT_LOGGER_BUILDER_H
#define COURSE_WORK_DATA_BASE_CLIENT_LOGGER_BUILDER_H
...
public:
    ...
    logger_builder* transform_with_configuration(std::string const &configuration_file_path, std::string const &configuration_path);
...
#endif //COURSE_WORK_DATA_BASE_CLIENT_LOGGER_BUILDER_H
