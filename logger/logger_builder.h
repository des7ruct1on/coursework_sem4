#ifndef COURSE_WORK_DATA_BASE_LOGGER_BUILDER_H
#define COURSE_WORK_DATA_BASE_LOGGER_BUILDER_H
...
public:
    ...
    virtual logger_builder* add_format_string(
            std::string const &format_string) = 0; 
...
#endif //COURSE_WORK_DATA_BASE_LOGGER_BUILDER_H
