...
#ifndef COURSE_WORK_DATA_BASE_B_TREE_H
#define COURSE_WORK_DATA_BASE_B_TREE_H
...
{
    update_inner(std::move(typename associative_container<tkey, tvalue>::key_value_pair(key, value)));
}
...
#endif //COURSE_WORK_DATA_BASE_B_TREE_H
